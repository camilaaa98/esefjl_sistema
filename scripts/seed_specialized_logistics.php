...
try {
    ...
    echo "ðŸ­ CARGANDO PROVEEDORES Y PRODUCTOS ESPECIALIZADOS...\n";

    // 1. Ampliar Categorías
    $nuevasCats = ['ODONTOLOGíA', 'PLANIFICACIí“N FAMILIAR', 'PRUEBAS DIAGNí“STICAS', 'GASES MEDICINALES', 'MATERIAL QUIRíšRGICO'];
    ...
    $proveedores = [
        ...
        ['901987654-3', 'LABORATORIOS DIAGNí“STIX', 'Samuel Torres', 'Pruebas de ETS, Citología y diagnósticos rápidos.'],
        ['800321654-4', 'OXíGENOS DEL CAQUETí', 'Hernán Darío Gómez', 'Suministro de gases medicinales y mantenimiento de balas.'],
        ['900753159-5', 'BIOMí‰DICOS JERINGAS Y MíS', 'Martha Lucía Ortiz', 'Dispositivos médicos descartables y esterilizados.'],
        ...
        ['800246813-8', 'QUIRíšRGICOS DEL VALLE', 'Andrés Felipe Arias', 'Todo en material quirúrgico y kits de citología.'],
    ...
    $productos = [
        ['Kit Resinador Odontológico', 'ODONTOLOGíA', 'Kit x 5 jeringas', '3M'],
        ['Amalgama Dental Plata', 'ODONTOLOGíA', 'Frasco x 50 cápsulas', 'COLTENE'],
        ['Preservativos de Látex', 'PLANIFICACIí“N FAMILIAR', 'Caja x 144', 'TODAY'],
        ['Prueba Rápida VIH/Sífilis', 'PRUEBAS DIAGNí“STICAS', 'Caja x 20 test', 'ABBOTT'],
        ...
        ['Kit Citología Estéril', 'PRUEBAS DIAGNí“STICAS', 'Unidad con espátula/cepillo', 'LAPROFF'],
        ['Jeringa de Insulina 100 UI', 'MATERIAL QUIRíšRGICO', 'Caja x 100', 'BD'],
        ['Anticonceptivo Mensual Inyectable', 'PLANIFICACIí“N FAMILIAR', 'Ampolla 1ml', 'NOFERTYL'],
        ['Espéculo Vaginal Descartable', 'PRUEBAS DIAGNí“STICAS', 'Unidad Talla M', 'TEXPON']
    ];
    ...
    $db->commit();
    echo "✅ í‰XITO: Proveedores y productos especializados cargados.\n";
