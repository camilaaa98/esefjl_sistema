...
<head>
    ...
    <title>MÃ³dulo de Entregas - SISFARMA PRO</title>
        ...
        <main class="content-area fade-in-institutional flex justify-center items-center py-12">
            <div class="max-w-xl w-full bg-white p-10 md:p-16 rounded-[4rem] shadow-2xl border border-slate-100 relative overflow-hidden">
                ...
                <header class="text-center mb-12 relative z-10">
                    <span class="inline-block px-4 py-1.5 bg-[#111111] text-[#d4af37] text-[8px] font-black rounded-full uppercase tracking-[0.4em] mb-6 border border-[#d4af37]/30">Protocolo de DispensaciÃ³n</span>
                    <h2 class="text-3xl font-black text-[#111111] italic uppercase tracking-tighter leading-none mb-3">Registro TÃ©cnico de <span class="text-[#d4af37]">Entrega</span></h2>
                    <p class="text-slate-400 text-[10px] font-bold uppercase tracking-[0.2em] mt-1">Soporte FarmacolÃ³gico SISFARMA Ã‰LITE</p>
                </header>
                ...
                <form method="POST" class="space-y-8 relative z-10">
                    <div class="space-y-3">
                        <label class="block text-[9px] font-black text-slate-400 uppercase tracking-[0.3em] ml-2">IdentificaciÃ³n del Ciudadano</label>
                    ...
                    <div class="space-y-3">
                        <label class="block text-[9px] font-black text-slate-400 uppercase tracking-[0.3em] ml-2">Suministro FarmacolÃ³gico</label>
                ...
                <?php if ($resultado_entrega): ?>
                    <div class="mt-12 p-8 bg-slate-50 rounded-[2rem] border border-slate-100 relative group overflow-hidden">
                        ...
                        <span class="block text-[8px] font-black text-[#d4af37] uppercase tracking-[0.4em] mb-4 italic">Log de ComunicaciÃ³n Ã‰lite</span>
