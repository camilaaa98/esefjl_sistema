...
<head>
    <meta charset="UTF-8">
    <title>Sustentación ULTRA-PRO — FARMACIA ESEFJL | ESE FJL</title>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .pres-wrap::after {
            ...
            position: absolute;
            inset: 0;
            background: url('<?= BASE_URL ?>/img/fondo.jpg') no-repeat center center;
...
<a href="inicio" class="exit-btn">í¢â€ Â SALIR AL PANEL</a>
    ...
    <div class="slides-track" id="track">
        ...
        <div class="slide">
            <div class="slide-content">
                <div class="slide-tag">ESE Fabio Jaramillo Londoño í‚Â· Proyecto Institucional í‚Â· 2026</div>
            ...
            <div class="slide-visual">
                <img src="<?= BASE_URL ?>/img/logoesefjl.jpg" alt="ESE FJL Logo" style="object-fit: contain; padding: 40px; background: white; border-radius: 20px;">
        ...
        <div class="slide">
            <div class="slide-content">
                ...
                <ul class="feat-list">
                    <li><span class="icon">âš ï¸Â</span><div><strong>Pérdida por Vencimiento</strong><br><small style="color:var(--text-dim)">Lotes vencidos por falta de alertas proactivas.</small></div></li>
        ...
        <div class="slide">
            <div class="slide-content">
                <div class="slide-tag">02 — FARMACIA ESEFJL</div>
                ...
                <ul class="feat-list">
                    <li><span class="icon">í°Å¸Å¡Â¨</span><div><strong>Alertas de Vigencia</strong><br><small style="color:var(--text-dim)">Notificaciones automáticas según semaforización técnica.</small></div></li>
        ...
        <div class="slide">
            <div class="slide-content">
                ...
                <ul class="feat-list">
                    <li><span class="icon">í°Å¸Ââ€ºí¯Â¸Â</span><div><strong>Punto Central (Florencia)</strong><br><small style="color:var(--text-dim)">Coordinación de compras y control de stock nacional.</small></div></li>
                    <li><span class="icon">í°Å¸ÂÂ¥</span><div><strong>Sedes Municipales</strong><br><small style="color:var(--text-dim)">Suministro local y reporte de necesidades en tiempo real.</small></div></li>
                    <li><span class="icon">í¢Å¡Â¡</span><div><strong>Sincronización Asíncrona</strong><br><small style="color:var(--text-dim)">Funcionamiento garantizado incluso en zonas de baja conectividad.</small></div></li>
                </ul>
            </div>
            <div class="slide-visual">
                <img src="<?= BASE_URL ?>/img/fondo.jpg" alt="Fondo Institucional" class="bg-slide-img" style="opacity: 0.3;">
                <div class="arch-grid" style="position: relative; z-index: 1;">
                    <div class="arch-node" style="border-color: var(--secondary);">
                        <div class="arch-icon">í°Å¸Ââ€ºí¯Â¸Â</div>
                        <div class="arch-label"><strong>CEDIS — Florencia</strong><span>Nodo Administrativo Principal</span></div>
                    </div>
                    <div style="text-align:center; color: var(--secondary); font-size: 1.5rem;">í¢â€ •</div>
                    <?php
                    $ips = ['Solita', 'Solano', 'Milán', 'Getuchá', 'Valparaíso'];
                    foreach ($ips as $i): ?>
                    <div class="arch-node">
                        <div class="arch-icon">í°Å¸ÂÂ¥</div>
        ...
        <div class="slide">
            <div class="slide-content">
                ...
                <ul class="feat-list">
                    <li><span class="icon">í¢Å¡â„¢í¯Â¸Â</span><div><strong>Lenguaje: PHP 8.x</strong><br><small style="color:var(--text-dim)">Lógica de servidor robusta y escalable.</small></div></li>
                    <li><span class="icon">í°Å¸—Æ’í¯Â¸Â</span><div><strong>Motor: SQLite</strong><br><small style="color:var(--text-dim)">Base de datos portable que no requiere servidor externo.</small></div></li>
            ...
            <div class="slide-visual">
                <div style="padding: 30px; width: 100%; text-align: center;">
                    ...
                    <div style="display:grid; grid-template-columns: 1fr 1fr; gap: 10px; text-align: left;">
                        <?php foreach(['PHP 8.x' => 'í¢Å¡â„¢í¯Â¸Â', 'SQLite' => 'í°Å¸—Æ’í¯Â¸Â', 'CSS Pro' => '🎨', 'WAMP' => 'í°Å¸â€“Â¥í¯Â¸Â'] as $tech => $icon): ?>
        ...
        <div class="slide">
            <div class="slide-content">
                ...
                <ul class="feat-list">
                    ...
                    <li><span class="icon">í°Å¸â€â€ž</span><div><strong>Sincronización</strong><br><small style="color:var(--text-dim)">Los registros pendientes se actualizan automáticamente al restaurar servicio.</small></div></li>
                    <li><span class="icon">í°Å¸â€œÂ</span><div><strong>Registro de Eventos</strong><br><small style="color:var(--text-dim)">Auditoría completa de movimientos en cualquier condición de red.</small></div></li>
                </ul>
            </div>
            <div class="slide-visual">
                <div style="padding: 30px; text-align: center; width: 100%;">
                    <div style="font-size:5rem; margin-bottom:20px;">í¢Å¡Â¡</div>
                    <div style="background: rgba(255,82,82,0.1); border: 1px solid #ff5252; border-radius: 12px; padding: 15px; margin-bottom: 10px; color:#ff5252; font-weight:700;">âš ï¸Â API FALLA</div>
                    <div style="color: var(--text-dim); font-size: 1.5rem;">↓</div>
                    <div style="background: rgba(100,255,218,0.1); border: 1px solid var(--secondary); border-radius: 12px; padding: 15px; color:var(--secondary); font-weight:700;">✅â€¦ MODO LOCAL ACTIVO</div>
        ...
        <div class="slide">
            <div class="slide-content">
                ...
                <ul class="feat-list">
                    <li><span class="icon">í°Å¸â€â€˜</span><div><strong>Coordinación Central</strong><br><small style="color:var(--text-dim)">Supervisión total y configuración de parámetros.</small></div></li>
                    <li><span class="icon">í°Å¸â€˜Â©í¢â‚¬Âí¢Å¡•í¯Â¸Â</span><div><strong>Servicios Farmacéuticos IPS</strong><br><small style="color:var(--text-dim)">Gestión de stock municipal y dispensación.</small></div></li>
            ...
            <div class="slide-visual">
                <div style="padding: 25px; width: 100%;">
                    <?php
                    $users = [
                        ['í°Å¸Ââ€ºí¯Â¸Â', 'ADMINISTRADOR', 'Florencia — CEDIS', '#64ffda'],
                        ['í°Å¸â€˜Â©í¢â‚¬Âí¢Å¡•í¯Â¸Â', 'JEFE ENFERMERíA', 'Solita IPS', '#8892b0'],
                        ['í°Å¸â€˜Â©í¢â‚¬Âí¢Å¡•í¯Â¸Â', 'JEFE ENFERMERíA', 'Solano IPS', '#8892b0'],
                        ['í°Å¸â€˜Â©í¢â‚¬Âí¢Å¡•í¯Â¸Â', 'JEFE ENFERMERíA', 'Milán IPS', '#8892b0'],
                    ];
                    foreach ($users as $u): ?>
        ...
        <div class="slide">
            <div class="slide-content">
                ...
                <ul class="feat-list">
                    <li><span class="icon">✅â€¦</span><div><strong>Fase 1:</strong> Análisis de requisitos y entorno local</div></li>
                    <li><span class="icon">✅â€¦</span><div><strong>Fase 2:</strong> Desarrollo de módulos de inventario</div></li>
                    <li><span class="icon">í°Å¸â€â€ž</span><div><strong>Fase 3:</strong> Despliegue en red IPS y alertas</div></li>
                    <li><span class="icon">í¢ÂÂ³</span><div><strong>Fase 4:</strong> Pruebas finales y entrega técnica</div></li>
                </ul>
            </div>
            <div class="slide-visual">
                <div class="roadmap" style="position: relative; z-index: 1;">
                    <div class="road-item done"><span style="font-size:1.2rem;">✅â€¦</span><div><div style="color:var(--secondary); font-size:0.85rem; font-weight:700;">Semana 1</div><div style="color:var(--text-dim); font-size:0.75rem;">Taller y Stack Tecnológico</div></div><span class="road-badge badge-done">LISTO</span></div>
                    <div class="road-item done"><span style="font-size:1.2rem;">✅â€¦</span><div><div style="color:var(--secondary); font-size:0.85rem; font-weight:700;">Semana 2</div><div style="color:var(--text-dim); font-size:0.75rem;">Inventario y Distribución Core</div></div><span class="road-badge badge-done">LISTO</span></div>
                    <div class="road-item active-road"><span style="font-size:1.2rem;">í°Å¸â€â€ž</span><div><div style="color:var(--accent); font-size:0.85rem; font-weight:700;">Semana 3</div><div style="color:var(--text-dim); font-size:0.75rem;">Red IPS + Alertas de Salud</div></div><span class="road-badge badge-active">EN CURSO</span></div>
                    <div class="road-item pending"><span style="font-size:1.2rem;">í¢ÂÂ³</span><div><div style="font-size:0.85rem; font-weight:700;">Semana 4</div><div style="color:var(--text-dim); font-size:0.75rem;">Auditoría y Despliegue Final</div></div><span class="road-badge badge-pend">PRíƒâ€œXIMO</span></div>
                </div>
            </div>
        </div>
...
CREATE TABLE sedes (
    ...
    nombre, ciudad...
        ...
        <!-- SLIDE 14: CONCLUSIíƒâ€œN -->
        <div class="slide">
            <div class="slide-content">
                <div class="slide-tag">Cierre</div>
                <h1 class="slide-title">Compromiso<br><span>Institucional</span></h1>
                <p class="slide-sub">FARMACIA ESEFJL es una solución robusta enfocada en la eficiencia operativa y el bienestar del ciudadano.</p>
                <div class="stat-row" style="margin-top: 30px;">
            ...
            <div class="slide-visual">
                <div style="text-align:center; padding: 30px;">
                    <div style="font-size:6rem;">✅â€¦</div>
                    ...
                    <div style="margin-top:20px; border-top: 1px solid var(--border); padding-top: 15px; color: var(--text-dim); font-size:0.75rem;">
                        ESE Fabio Jaramillo Londoño í‚Â· Gestión 2026
                    </div>
                </div>
            </div>
        </div>
...
<!-- NAV BAR -->
<div class="nav-bar">
    <button class="nav-btn" id="prevBtn" onclick="navTo(-1)">í¢—â‚¬ ANTERIOR</button>
    <div class="slide-counter" id="counter">1 / 14</div>
    <button class="nav-btn" id="nextBtn" onclick="navTo(1)">SIGUIENTE í¢â€“Â¶</button>
</div>
...
function update() {
    ...
    document.getElementById('nextBtn').innerText = cur === total - 1 ? 'í°Å¸ÂÂ FINALIZAR' : 'SIGUIENTE í¢â€“Â¶';
